...
void test_concatenate(void) {
    ...
    Concatenate_arrays(test_input1, test_input2, current_result, size, size, size);
    ...
    Concatenate_arrays(test_input11, test_input21, current_result1, size1, size1, size1);
